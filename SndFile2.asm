...
EXTRN WireValA:BYTE ;Needed by SndFile2
EXTRN UsrInCnt:WORD
EXTRN OtCnt:WORD
EXTRN OtTot:WORD
EXTRN TotComb:WORD
EXTRN TTableA:BYTE 
EXTRN SimDS:WORD 
Data_segment_name_SndFile2 segment para
temp1   db    ? 
LF      DB 0AH 
SLASH   DB ' - '
MainDS  DW ?
...
Data_segment_name_SndFile2 ends
...
assume SS:Stack_segment_name,CS:Code_segment_name,DS:Data_segment_name_SndFile2
	PUSH DS
	...
	MOV AX,Data_segment_name_SndFile2 ; load the starting address of the data
