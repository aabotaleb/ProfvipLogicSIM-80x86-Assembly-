PUBLIC RecFile
EXTRN WireValA:BYTE ;Needed by RecFile
EXTRN UsrInCnt:WORD
EXTRN OtCnt:WORD
EXTRN OtTot:WORD
EXTRN TotComb:WORD
EXTRN TTableA:BYTE 
EXTRN SimDS:WORD 
Data_segment_name_RecFile segment para
FileNameR  DB 'Rec1.txt',00
...
Data_segment_name_RecFile ends
...
assume SS:Stack_segment_name,CS:Code_segment_name,DS:Data_segment_name_RecFile
	PUSH DS
	...
	MOV AX,Data_segment_name_RecFile ; load the starting address of the data
...
Receive proc near
ee:	mov dx,3FDh        ;Line status register
	In al,dx
